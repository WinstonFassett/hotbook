...
// Per-scenario warmup happens inside mitata; we add an extra 200-iter
// pre-warm to stabilise the JIT before timing starts.

import "../_test/setup";
import { Anim, type Animator, drive, suspend } from "@bireactive/animation";
