...
(cd apps/hotbook && npx vite build --base /sliceboard/)
...
(cd packages/layout && npx vite build --base /demos/bireactive-native-layout/)

echo "==> Assembling site..."
# Copy demo builds into docs dist at their subpaths
cp -r apps/hotbook/dist apps/docs/dist/sliceboard
...
cp -r packages/layout/dist apps/docs/dist/demos/bireactive-native-layout
